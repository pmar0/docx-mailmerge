...
class IgnoreNextRecordGetMergeFieldsTest(unittest.TestCase):
    def test_get_merge_fields(self):
        ...
        self.assertEqual('NextRecordRule' in document.get_merge_fields(), False)
        self.assertEqual('NextRecordRule' in document.get_merge_fields(ignore_next_records=False), True)